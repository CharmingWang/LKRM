...
class resnet(_FPN):
  ...
  def _init_modules(self):
    ...
    if self.hkrms_exist[2]:
      # yinzi3 = yinzi
      yinzi3 = 1
    else:
      yinzi3 = 0
    self.RCNN_cls_score = nn.Linear(1024 + self.modules_size * yinzi1, self.n_classes)
    if self.class_agnostic:
        self.RCNN_bbox_pred = nn.Linear(1024 + self.modules_size * yinzi1, 4)
    else:
        self.RCNN_bbox_pred = nn.Linear(1024 + self.modules_size * yinzi1, 4 * self.n_classes)

    self.RCNN_cls_score_2nd = nn.Linear(1024 + self.modules_size * yinzi2, self.n_classes)
    if self.class_agnostic:
        self.RCNN_bbox_pred_2nd = nn.Linear(1024 + self.modules_size * yinzi2, 4)
    else:
        self.RCNN_bbox_pred_2nd = nn.Linear(1024 + self.modules_size * yinzi2, 4 * self.n_classes)

    self.RCNN_cls_score_3rd = nn.Linear(1024 + self.modules_size * yinzi3, self.n_classes)
    if self.class_agnostic:
        self.RCNN_bbox_pred_3rd = nn.Linear(1024 + self.modules_size * yinzi3, 4)
    else:
        self.RCNN_bbox_pred_3rd = nn.Linear(1024 + self.modules_size * yinzi3, 4 * self.n_classes)
